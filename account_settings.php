...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="https://ajax.googleapis.comajax/libs/jquery/3.3.1/jquery.min.js"></script>
      ...
      <div class="col-sm-8">
                          ...
                          <?php
                            if(isset($_POST['sub'])){
                              ...
                              if($bfn == ''){
                                ...
                                $update = "update user set forgotten_answer='$bfn'
        ...
        <?php
          if(isset($_POST['update'])){
            ...
            $update = "update user set user_name='$user_name', user_email=
            '$email' where
            user_email='$user'";
